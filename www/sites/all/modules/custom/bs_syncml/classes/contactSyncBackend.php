...
/**
 * Description of contactSyncBackend
 *
 * @author kauschke
 */
class contactSyncBackend implements dISyncMLClientBackend {
  protected $profile = null;
  
  public function contactSyncBackend($profile) {
  ...
  /**
    ...
    // TODO:
    /* Hier wird von dem zugehörigen Profil ein Callback-handler aufgerufen, der für eine Node-Id die
     * zuordnung zu einem VCard Objekt macht und dieses returned.
    */
