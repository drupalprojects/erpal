<div class="billable_field" id="billable_date_delivery">Delivery date: <?php echo date(_billable_get_date_format(false), $billable->date_delivery) ?></div>
...
<div class="billable_field" id="billable_created">Created: <?php echo date(_billable_get_date_format(), $billable->created) ?></div>
<div class="billable_field" id="billable_changed">Changed: <?php echo date(_billable_get_date_format(), $billable->changed) ?></div>
